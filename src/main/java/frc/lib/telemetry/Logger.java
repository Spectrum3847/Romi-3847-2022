 ...
 *
 * <p>You can turn off all debug messages easily. You can also set different Flag levels.
 */
public class Logger {
    ...
    /**
     * Check if we should print the message based on flag and level Print the level and flag as well
    ...
    private static EventImportance logLevelToEventImportance(int level) {
        switch (level) {
            case 1:
                return EventImportance.kLow;
            case 2:
                return EventImportance.kNormal;
            case 3:
                return EventImportance.kHigh;
            case 4:
                return EventImportance.kCritical;
            default:
                return EventImportance.kTrivial;
        }
    }
}
